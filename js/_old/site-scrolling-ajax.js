...
$(window).on('load',function(){
  ...
  $('#load-content').click(function(){
    $.ajax({
      type: 'GET',
      url: '/work/songs-for-the-fallen',
      success: function(result) {
        console.log(result);
          document.title = 'Songs For the Fallen';
          window.history.pushState({"html":result,"pageTitle":"Songs for the Fallen"},"", "/work/songs-for-the-fallen");
           $('#work .row').html(result);
           loadPage();
      }
    });
  });
